...
internal class ActionWrapper<TRequest, TResponse>(IAction<TRequest, TResponse> action)
{
    // TODO: exception handling, error response, release keys...
    public async Task<JsonHttpResult<ServerResponse<TResponse>>> Execute([FromBody] TRequest request)
    {
